...
from deepfold_pcs import DEEPFOLD_RS_PCS, Field
...
def random_test(k):
    ...
    DEEPFOLD_RS_PCS.blowup_factor = 8
    DEEPFOLD_RS_PCS.security_bits = 64
...
def failure_test_1(k):
    ...
    print("🕐 Verifying proof ....")
    try:
        checked = pcs.verify_eval(f_cm, us, v + Field(1), arg, tr.fork(b"deepfold_rs_pcs"))
        assert checked
        print("❌ Proof passed")
